...
IF /I #%ECOMPASS%#==#FAIL# GOTO FAIL
IF /I #%ACCELEROMETER%#==#FAIL# GOTO FAIL
goto pass

:PASS
color 2f
>.\log\Test_I2C_AccelerometerSensor_ISM303DAC_CheckLog.bat echo set I2C_AccelerometerSensor_ISM303DAC=PASS
