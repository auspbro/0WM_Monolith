...
:PASS
color 2f
>.\log\Test_DP_HDMI_Port1_CheckLog.bat echo set DP_HDMI_Port1=PASS
>>.\log\Test_DP_HDMI_Port1_CheckLog.bat echo set TestResult=PASS
cd .\Process
call sdtCheckLog.exe Model_MLBTEST.cfg DP_HDMI_Port1
cd..
GOTO END
