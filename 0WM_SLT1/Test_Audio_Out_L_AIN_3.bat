...
CALL .\log\%tmSN%\result\Audio_Out_L_AIN_3.cmd
IF /I #%Audio_Out_L_AIN_3%#==#PASS# goto pass
goto fail

:PASS
color 2f
>.\log\Test_Audio_Out_L_AIN_3_CheckLog.bat echo set Audio_Out_L_AIN_3=PASS
