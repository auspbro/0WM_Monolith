...
if "%rssi_value%" LSS "%loss_rssi%" goto BT_TX_LOW_PASS
goto BT_TX_LOW_FAIL

:BT_TX_LOW_PASS
echo set BT_TX_LOW=PASS >C:\Testprogram\QF7\%F_N%\LOG\BT_TX_LOW_LOG.bat 
goto BT_HIGH_POWER

:BT_TX_LOW_FAIL
echo set BT_TX_LOW=FAIL >>C:\Testprogram\QF7\%F_N%\LOG\BT_TX_LOW_LOG.bat
goto fail
...
if "%rssi_value%" LSS "%high_rssi%" goto BT_TX_HIGH_PASS
goto BT_TX_HIGH_FAIL

:BT_TX_HIGH_PASS
echo set BT_TX_HIGH=PASS >C:\Testprogram\QF7\%F_N%\LOG\BT_TX_HIGH_LOG.bat 
goto pass

:BT_TX_HIGH_FAIL
echo set BT_TX_HIGH=FAIL >>C:\Testprogram\QF7\%F_N%\LOG\BT_TX_HIGH_LOG.bat
goto fail
