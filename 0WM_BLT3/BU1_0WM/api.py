...
Android console :
    ...
    DefaultBootPrompt = DefaultShellPrompt
'''
waitForLogin = 'monolith login:'
ShellPrompt = 'root@monolith:'
ShellSymbol = '~#'
...
def machine_reboot(REBOOT_CMD='reboot',DISPLAY_ENABLE=True, TIMEOUT=60):
    send_cmd( REBOOT_CMD ).split('\n')
    print machine_wait_for_boot(DISPLAY_ENABLE, TIMEOUT)
    '''
    results = ''
    found = False
    while True:
